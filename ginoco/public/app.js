...
const I18N = {
  ...
  fa: {
    tagline_student: 'رزرو آسان آنلاین جلسات رانندگی', tagline_admin: 'بخش مربی',
    feat_book: '📅 خودت رزرو کن', feat_swap: '🎁 تعویض', feat_pickup: '📍 محل ملاقات',
    feat_day: '📅 برنامه روز', feat_students: '🧑‍🎓 هنرجویان', feat_reviews: '⭐ نظرات', feat_push: '🔔 اعلان‌ها',
    tab_login: 'ورود', tab_register: 'جدید (با کد)', tab_signup: 'اینجا تازه‌واردی؟', tab_instr: 'مربی',
    appearance: '🎨 ظاهر', lang_section: '🌍 زبان', terms: 'شرایط استفاده', privacy: 'حریم خصوصی', imprint: 'اطلاعات ناشر', or: 'یا',
    login_id: 'نام کاربری یا ایمیل', login_pw: 'رمز عبور', login_go: 'ورود',
    login_forgot_q: 'رمز عبور را فراموش کرده‌ای؟', login_forgot_link: 'یک رمز جدید بخواه', login_forgot_tail: '– مربی‌ات برایت رمز عبور تعیین می‌کند.',
    reg_intro: 'از مربی‌ات کد دسترسی گرفته‌ای؟ با آن یک بار حسابت را همین‌جا بساز. نام کاربری‌ات پس از آن نمایش داده می‌شود.',
    reg_code: 'کد دسترسی', reg_name: 'نام', reg_name_ph: 'نام و نام خانوادگی', reg_year: 'سال تولد',
    reg_email: 'ایمیل (اختیاری)', reg_phone: 'تلفن (اختیاری)', reg_pw: 'رمز عبور',
    reg_pw_hint: 'حداقل ۸ نویسه، شامل حرف، عدد و یک نماد ویژه (مثل ! ? # @).', reg_go: 'ساخت حساب',
    instr_intro: 'فقط برای مربی.', instr_pin: 'کد PIN یا رمز عبور', instr_code: 'کد تأیید',
    instr_code_ph: 'کد ۶ رقمی', instr_remember: 'مرا به خاطر بسپار', instr_go: 'ورود',
    instr_passkey: '🔓 ورود با Face ID / کلید عبور', instr_forgot: 'رمز عبور را فراموش کرده‌ای؟',
    gate_title: '👋 به ginoco خوش آمدی',
    gate_text: 'پیش از شروع: لطفاً <strong>شرایط استفاده</strong> و <strong>سیاست حریم خصوصی</strong> را به‌طور خلاصه بخوان. با کلیک روی «متوجه شدم و می‌پذیرم» تأیید می‌کنی که آن‌ها را دیده‌ای.',
    gate_terms: '📄 شرایط استفاده', gate_privacy: '🔒 حریم خصوصی',
    gate_fallback: 'بارگذاری نمی‌شود؟ مستقیم باز کن:', gate_later: 'بعداً', gate_ok: 'متوجه شدم و می‌پذیرم',
    book_title: 'رزرو نوبت', today: 'امروز', find_free: '🔎 نزدیک‌ترین نوبت آزاد',
    horizon_note: '(تا {d} روز پیش‌تر)', horizon_note_rank: '(تا {d} روز پیش‌تر · سطح {r})',
    min: 'دقیقه', oclock: '', at_time: 'ساعت ',
    slots_none_title: 'روز {day} جلسه‌ای نیست',
    slots_none_text: 'مربی‌ات در این روز نوبتی ارائه نمی‌دهد. بگذار نزدیک‌ترین روز آزاد را برایت پیدا کنم.',
    find_free_long: '🔎 نزدیک‌ترین نوبت آزاد را پیدا کن',
    slot_dur: '{start}–{end} · {dur} دقیقه',
    slot_free_from_multi: 'آزاد از {start} · {durs} دقیقه',
    slot_free_from: 'آزاد از {start} · {dur} دقیقه',
    slot_mine: 'نوبت تو', slot_locked: '🔒 رزرو شده',
    free: 'آزاد', book: 'رزرو', taken: 'رزرو شده', offered_out: 'برای واگذاری ارائه شده',
    past: 'گذشته', toofar: 'هنوز در دسترس نیست', closed: 'بسته',
    slots_none_free: 'در این روز فعلاً وقت آزادی نیست.',
    cancel: 'لغو', abort: 'لغو', close: 'بستن',
    choose_duration: 'مدت را انتخاب کن', minutes_opt: '{d} دقیقه',
    book_nofit: 'هیچ‌کدام از مدت‌های جلسهٔ تو در این ساعت از روز جا نمی‌شود{cap}. لطفاً وقت زودتری انتخاب کن.',
    book_nofit_cap: ' ({n} دقیقه تا پایان روز مانده)',
    book_confirm_title: 'رزرو نوبت تأیید شود؟',
    book_confirm_text: 'مطمئنی این نوبت را می‌خواهی؟',
    book_rule1: 'لغو رایگان فقط تا {h} ساعت پیش از نوبت.',
    book_rule2: 'از {h} ساعت پیش‌تر نوبت قطعی می‌شود – پس از آن لغو ممکن نیست.',
    book_rule3: 'در فاصلهٔ بین این دو می‌توانی جلسه را به دیگران پیشنهاد بدهی.',
    book_go: 'بله، رزرو کن',
    toast_booked: 'رزرو شد ✓', celebrate_booked: 'رزرو شد',
    cancel_confirm: 'واقعاً این نوبت لغو شود؟', toast_cancelled: 'لغو شد',
    cx_title_free: 'جلسه لغو شود؟', cx_free_text: 'رایگان – بیش از {h} ساعت مانده و لغو می‌کنی.',
    cx_title_late: '⚠️ لغو دیرهنگام', cx_keep: 'نگه‌داشتن',
    cx_late_text: 'لغو در این زمان کوتاه <strong>هزینه دارد – تا ۷۵٪</strong> محاسبه می‌شود. بهتر است: جلسه را <strong>برای گرفتن دیگران</strong> پیشنهاد بده – اگر کسی آن را بگیرد، رایگان آزاد می‌شوی.',
    cx_offer_btn: '🎁 بهتر است پیشنهاد بدهی (رایگان)', cx_cancel_free: 'بله، لغو کن', cx_cancel_late: 'با این حال لغو کن (۷۵٪)',
    cx_done_free: 'جلسه لغو شد.', cx_done_late: 'دیرهنگام لغو شد – به مربی‌ات اطلاع داده شد.',
    toast_accepted: 'نوبت پذیرفته شد ✓', toast_taken: 'جلسه گرفته شد ✓',
    celebrate_taken: 'گرفته شد', toast_declined: 'رد شد',
    ds_rush: 'ترافیک ساعت شلوغی', ds_jam: 'راه‌بندان', ds_snow: 'برف', ds_ice: 'یخبندان', ds_weather: 'شرایط آب‌وهوایی', ds_other: 'سایر',
    ds_reason_label: 'دلیل: ',
    ds_delay_title: 'امروز کمی کندتر — حدود {min} دقیقه',
    ds_delay_text: 'نوبت تو سر جایش می‌ماند – لطفاً سر وقت حاضر باش.',
    ds_ok_title: 'امروز همه‌چیز طبق برنامه پیش می‌رود', ds_ok_text: 'مربی‌ات طبق برنامه است. بعداً می‌بینمت!',
    away_vacation: '🌴 <strong>مربی در مرخصی است:</strong> {dates} – در این روزها جلسه‌ای نیست.',
    notif_title: '🔔 اعلان‌ها', notif_new: '{n} تازه', notif_sign_btn: '✍️ همین حالا امضا کن',
    notif_mark_read: 'همه را خوانده‌شده کن', notif_none: 'اعلانی نیست.', lesson_not_found: 'جلسه پیدا نشد',
    offers_title: '🎁 پیشنهادها', offers_sub: 'جلساتی که دیگران واگذار می‌کنند',
    offers_limit: 'این هفته به سقفت رسیده‌ای – گرفتن جلسه برای این هفته قفل است.',
    offers_from: '🙋 از {name}', offers_anon: '🕶️ ناشناس', offers_take_q: '· می‌خواهی بگیری‌اش؟',
    take: 'گرفتن', no_time: 'وقت ندارم',
    offer_give_title: '🎁 این جلسه را پیشنهاد بده',
    offer_give_text: 'جلسه‌ات به <strong>پیشنهادها</strong> می‌رود – هنرجویان دیگر می‌توانند آن را بگیرند. اگر کسی نگیرد، طبق معمول برای تو می‌ماند.',
    offer_recognizable_q: 'می‌خواهی شناخته شوی؟',
    offer_anon_btn: '🕶️ واگذاری ناشناس', offer_anon_sub: 'هیچ‌کس نمی‌بیند جلسه از توست',
    offer_named_btn: '🙋 واگذاری با نام «{name}»', offer_named_sub: 'دیگران فقط نام کوچکت را می‌بینند',
    toast_offered: 'به پیشنهادها افزوده شد ✓',
    role_student: 'هنرجو', role_instructor: 'مربی', logout: 'خروج',
    tip_tour: 'راهنما و معرفی', tip_profile: 'پروفایل من', tip_appearance: 'ظاهر و رنگ‌ها',
    help_title: 'راهنما', help_sub: 'چطور می‌توانیم کمک کنیم؟',
    help_tour: 'معرفی سریع', help_tour_sub: 'برنامه در ۵ گام',
    help_support: 'کمک و پشتیبانی', help_support_sub: 'آنچه نیاز داری برایمان بنویس',
    ...
    ml_title: '📖 جلسات من',
    fb_title: '📖 دفتر خطاهای تو', fb_hint: 'چیزهایی که دفعهٔ بعد باید به آن‌ها دقت کنی – مربی‌ات یادداشت کرده (همراه محل و عکس).', fb_map: 'روی نقشه',
    ml_hint: 'همهٔ جلساتی که رانده‌ای – با تاریخ، ساعت، مدت، نوع و یادداشت. برای هر جلسه می‌توانی کارت آموزش را باز کنی: <em>چه چیزی</em> تمرین شده و چقدر جا افتاده.',
    ml_overview_btn: '📋 خلاصهٔ آموزش', ml_print_btn: '📄 چاپ سوابق',
    ml_filter_from: 'از', ml_filter_to: 'تا', ml_filter_reset: 'کل بازه', ml_filter_title: '🧾 سوابق · بازه را انتخاب کن',
    ml_filter_count: '{n} از {all} جلسه در این بازه', ml_filter_none: 'در این بازه جلسه‌ای نیست.',
    ml_th_when: 'تاریخ و ساعت', ml_th_end: 'پایان', ml_th_dur: 'مدت', ml_th_type: 'نوع', ml_th_late: 'تأخیر', ml_th_note: 'یادداشت / کارت آموزش',
    ml_dl_when: 'کِی', ml_dl_late: 'تأخیر', ml_dl_note: 'یادداشت',
    ml_driven_on: 'رانده‌شده در', ml_entered_on: 'مربی‌ات در {date} ثبت کرد',
    ml_on_invoice: '🧾 در صورت‌حساب {date} نمایش داده می‌شود', ml_on_invoice_time: '🧾 در صورت‌حساب {date} ساعت {time} نمایش داده می‌شود',
    ml_sign_btn: '✍️ امضا', ml_signed: '✓ امضا شد',
    ml_until: 'تا {end}', ml_absent: '🚫 حاضر نشد', ml_late: '⏱️ {late} دقیقه تأخیر',
    ml_adk_card: '📋 کارت آموزش ({n})',
    ml_banner_one: '{n} جلسه در انتظار امضای توست.', ml_banner_many: '{n} جلسه در انتظار امضای توست.',
    ml_banner_sub: 'مربی‌ات آن‌ها را ثبت کرده – لطفاً به‌طور کوتاه تأیید کن.', ml_banner_btn: 'همین حالا امضا کن',
    sign_title: '✍️ تأیید جلسه',
    sign_hint: 'یک نگاه کوتاه بینداز و با امضایت تأیید کن – در سوابق جلساتت درج می‌شود.',
    sign_practiced: '📋 چه چیزی تمرین شد', sign_fl_signed: '✓ مربی‌ات امضا کرد',
    sign_your: 'امضای تو', sign_draw: '(با انگشتت بکش)', clear: 'پاک کردن',
    sign_confirm_ck: 'تأیید می‌کنم که این جلسه را رانده‌ام.', sign_go: 'تأیید ✍️',
    saving: 'در حال ذخیره …', toast_signed: 'امضا شد – ممنون! ✓',
    greet_welcome: 'خوشحالم که هستی', greet_morning: 'صبح بخیر', greet_day: 'سلام', greet_evening: 'عصر بخیر',
    cd_now: 'اکنون', cd_in_days: 'تا {d} روز دیگر', cd_in_hours: 'تا {h} ساعت دیگر', cd_in_min: 'تا {m} دقیقه دیگر',
    wk_next_label: 'جلسهٔ بعدی تو',
    wk_title: 'جلسات من', wk_sub: 'این هفته ({from}–{to})',
    wk_reserve_one: '🔶 <strong>{n} نوبت</strong> که مربی‌ات پیشنهاد کرده – لطفاً در پایین <strong>✅ بپذیر</strong> یا <strong>✕ رد کن</strong>.',
    wk_reserve_many: '🔶 <strong>{n} نوبت</strong> که مربی‌ات پیشنهاد کرده – لطفاً در پایین <strong>✅ بپذیر</strong> یا <strong>✕ رد کن</strong>.',
    wk_pill: '{count} از {max} رزرو · {remaining} باقی‌مانده',
    wk_ical: '📅 افزودن به تقویم',
    wk_empty_title: 'هنوز جلسه‌ای رزرو نشده',
    wk_empty_text: 'برای جلسهٔ بعدی‌ات آماده‌ای؟ مستقیم می‌برمت به نزدیک‌ترین نوبت آزاد – فقط روی ساعت بزن و رزرو کن.',
    bk_gear_manual: 'دنده‌ای', bk_gear_auto: 'اتوماتیک',
    bk_done: 'انجام شد', bk_offered: '🎁 پیشنهادشده', bk_withdraw: 'پس‌گرفتن',
    bk_reserved: '🔶 رزرو موقت', bk_accept: '✅ پذیرش', bk_reject: '✕ رد',
    bk_due: '⏳ لطفاً تا <strong>{when}</strong> پاسخ بده – وگرنه نوبت دوباره آزاد می‌شود.',
    bk_confirmed: '✅ تأییدشده', bk_locked: '🔒 قطعی', bk_offer_btn: '🎁 این جلسه را پیشنهاد بده', bk_move_btn: '🔄 جابه‌جایی',
    rs_help_self1: 'می‌خواهی این جلسه را به نوبت آزاد دیگری منتقل کنی – مشکلی نیست.',
    bk_offer_title: 'لغو رایگان فقط تا {h} ساعت پیش از نوبت – به‌جای آن جلسه را پیشنهاد بده',
    bk_in_h: '· تا {h} ساعت دیگر',
    pc_rank: '🏅 سطح {r}', pc_drives: '<strong>{n}</strong> جلسهٔ انجام‌شده',
    pc_to_rank2: 'مسیر رسیدن به سطح ۲', pc_to_rank2_hint: '<strong>{n}</strong> جلسهٔ دیگر – سپس <strong>{d} روز</strong> پیش‌تر می‌بینی.',
    pc_rank2_ok: '✅ سطح ۲ – {d} روز پیش‌تر می‌بینی',
    pc_sonder: 'سفرهای ویژه', pc_sonder_r2: 'از سطح ۲ قابل رزرو',
    pc_sonder_help: 'سفرهای اجباری برای آزمون رانندگی: بین‌شهری، بزرگراه و رانندگی در شب. اعداد نشان می‌دهند چقدر انجام داده‌ای.',
    pc_book_min: '+ رزرو {dur} دقیقه',
    pc_sonder_hint: 'سفرهای ویژه را از <strong>سطح ۲</strong> ({n} جلسه) می‌توانی خودت رزرو کنی.',
    pc_manual_info: 'ℹ️ بهتر است {need} تا از آن‌ها واحد دندهٔ دستی (۸۰ دقیقه) باشد – تو {have} تا داری.',
    pc_adk: '📋 کارت آموزش', pc_exam: '🎓 آمادگی آزمون',
    msg_you: 'تو', msg_title: '✉️ پیام‌ها', msg_to: 'به {who}', msg_placeholder: 'یک پیام بنویس …', send: 'ارسال',
    msg_none: 'هنوز پیامی نیست. به مربی‌ات پیام بده – مثلاً یک پرسش یا اگر دیر می‌رسی خبر بده.',
    rev_title: '⭐ نظر',
    rev_passed_t: 'تبریک – قبول شدی!', rev_passed_s: 'پرونده‌ات محفوظ می‌ماند. دوست داری به دیگران بگویی آموزشت چطور بود؟',
    rev_invite: 'اگر دوست داری، نظری بگذار – به‌عنوان توصیه در صفحهٔ اصلی Ginoco نمایش داده می‌شود.',
    rev_mode_full: 'با نام کامل', rev_mode_initials: 'با نام مخفف', rev_mode_anon: 'ناشناس',
    rev_shown: '{mode} نمایش داده می‌شود', rev_with_photo: ' · با عکس', rev_pending: ' · در حال بررسی',
    rev_edit: 'ویرایش نظر', rev_new: '⭐ نوشتن نظر',
    es_offers: 'الان کسی جلسه‌ای واگذار نمی‌کند. بعداً سر بزن – جلسات آزادی که می‌توانی بگیری اینجا نمایش داده می‌شوند.',
    es_notif: 'پیام جدیدی نیست. نوبت‌های جدید، جابه‌جایی‌ها یا پیشنهادها اینجا نمایش داده می‌شوند.',
    es_lesson_t: '🚗 جلسهٔ تو', es_lesson: 'دربارهٔ جلسهٔ بعدی‌ات اینجا دکمهٔ شروع و زمان‌سنج رانندگی نمایش داده می‌شود.',
    es_live_t: '📍 محل ملاقات', es_live: 'کمی پیش از جلسه‌ات، اینجا محل ملاقات و اینکه مربی‌ات کجاست را می‌بینی.',
    es_lessons: 'به‌محض اینکه اولین جلسه‌ات را رانندگی کنی، اینجا نمایش داده می‌شود – با تاریخ، ساعت، مدت و یادداشت. هر زمان می‌توانی از آن سابقه چاپ بگیری.',
    es_messages: 'به مربی‌ات پیام بده – مثلاً یک پرسش یا خبر سریع اگر دیر می‌رسی. گفت‌وگو در چند لحظه بارگذاری می‌شود.',
    lt_today: 'امروز <strong>{time}</strong> · {d} دقیقه رانندگی.',
    lt_press_start: 'وقتی جلسه‌ات شروع شد «شروع» را بزن – آنگاه زمان رانندگی‌ات کار می‌کند.',
    lt_start: '▶️ شروع جلسه', lt_running: '🚗 جلسه در جریان است',
    lt_time_up: '✅ وقت تمام شد', lt_done_text: 'جلسه‌ات تمام شد ({d} دقیقه). آفرین!',
    lt_remain: 'زمان رانندگی باقی‌مانده', lt_started: 'شروع {time} · {d} دقیقه', reset: 'بازنشانی',
    lt_toast_started: 'جلسه شروع شد – رانندگی ایمن! 🚗',
    lt_reset_confirm: 'زمان‌سنج بازنشانی شود؟ زمان رانندگی از نو شروع می‌شود.', lt_toast_reset: 'بازنشانی شد',
    live_map_loading: 'در حال بارگذاری نقشه …',
    live_hint: '🛰️ نقشه به‌طور خودکار به‌روزرسانی می‌شود – مستقیم می‌بینی مربی‌ات کجاست و کِی باید بیرون بروی.',
    ap_intro: 'ginoco را به سلیقهٔ خودت دربیاور – همه‌چیز روی همین دستگاه ذخیره می‌شود.',
    ap_theme: 'قالب', ap_accent: 'رنگ تأکید', ap_accent_sub: '(دکمه‌ها و زبانه‌ها)',
    ap_font: 'قلم', ap_ink: 'رنگ متن', ap_edge: 'رنگ منو', ap_edge_sub: '(دو طرف منو)',
    ap_standard: 'پیش‌فرض', ap_size: 'اندازهٔ قلم', ap_tone: 'صدای اعلان',
    ap_tone_chime: '🔔 زنگ (پیش‌فرض)', ap_tone_lock: '🚗🔒 قفل خودرو', ap_tone_off: '🔇 خاموش',
    ap_tone_hint: 'هنگام رسیدن پیام‌های جدید (مثل «چیزی در صندوق توست») در حالت باز بودن برنامه صدا پخش می‌کند.',
    reset_btn: 'بازنشانی', done: 'انجام شد', ap_reset_toast: 'به پیش‌فرض بازگشت', ap_own_color: 'رنگ دلخواه', probe: 'آزمایش',
    pf_open: 'ویرایش ▾', pf_close: 'بستن ▲', pf_my_profile: 'پروفایل من',
    pf_summary_empty: 'برای تکمیل کلیک کن', pf_years: '{a} سال',
    pf_change_photo: 'تغییر عکس', pf_remove_photo: 'حذف عکس',
    pf_privacy: '🔒 فقط مربی‌ات پروفایلت را می‌بیند – نه هنرجوی دیگر.',
    pf_personal: '👤 اطلاعات شخصی', pf_name: 'نام', pf_bdate: 'تاریخ تولد', pf_age: 'سن',
    pf_address: '🏠 نشانی', pf_geo: '📍 استفاده از موقعیت فعلی',
    pf_geo_hint: 'در خانه حوصله نداری؟ یک کلیک خیابان، کد پستی و شهر را پر می‌کند – فقط شمارهٔ پلاک را اضافه کن.',
    pf_street: 'خیابان', pf_houseno: 'پلاک', pf_zip: 'کد پستی', pf_city: 'شهر',
    pf_contact: '📞 تماس', pf_phone: 'شمارهٔ موبایل', pf_email: 'ایمیل (اختیاری)',
    pf_emailnotify: '📧 اعلان‌های ایمیلی', pf_emailnotify_hint: 'دریافت نوبت‌ها، یادآوری‌ها و پیشنهادها از طریق ایمیل هم.',
    rs_choose: 'یک نوبت جدید انتخاب کن', rs_gone: 'این جلسه دیگر در دسترس نیست.',
    rs_asked: 'مربی‌ات از تو می‌خواهد این جلسه را جابه‌جا کنی – کافی است در پایین یک نوبت آزاد جدید انتخاب کنی.',
    rs_help_title: '🔄 جابه‌جایی جلسه – به همین سادگی',
    rs_help_1: 'مربی‌ات از تو خواسته این جلسه را به نوبت دیگری منتقل کنی.',
    rs_help_2: 'در تقویم پایین روی یک روز بزن و یک نوبت آزاد (سبز) انتخاب کن – این نوبت جدید توست.',
    rs_help_3: 'تمام! جلسه‌ات به‌طور خودکار به نوبت جدید منتقل و نوبت قدیمی لغو می‌شود – و پیام تأیید دریافت می‌کنی.',
    rs_help_go: 'باشه – یک نوبت انتخاب کن', rs_mode_cancel: 'لغو',
    rs_mode_banner: '🔄 حالا در پایین یک نوبت آزاد (سبز) برای جلسهٔ جابه‌جاشده‌ات انتخاب کن.',
    rs_confirm_q: 'جلسه‌ات به {day} ساعت {time} منتقل شود؟',
    rs_confirm_go: 'بله، به اینجا منتقل کن', rs_moved: 'منتقل شد ✓ نوبت جدید: {day} ساعت {time}.',
    pf_access: '🔑 دسترسی', pf_login_fixed: 'نام کاربری (ثابت، تغییر نمی‌کند)', pf_reach_school: 'تماس با آموزشگاه',
    pf_save: 'ذخیره', pf_account: '⚠️ حساب', pf_del_account: '🗑️ حذف حسابم',
    pf_account_text: 'هر زمان می‌توانی خودت حسابت را حذف کنی. آنگاه دسترسی و اطلاعات شخصی‌ات حذف می‌شود. جلساتی که رانده‌ای – به‌صورت ناشناس – در سابقهٔ قانونی آموزش آموزشگاه باقی می‌ماند.',
    pf_ph_street: 'مثل Bahnhofstraße', pf_ph_houseno: '12a', pf_ph_zip: '89073', pf_ph_city: 'مثل Ulm', pf_ph_phone: 'مثل 0151 23456789', pf_ph_email: 'name@mail.com',
    tour_skip: 'رد کردن', tour_prev: 'قبلی', tour_next: 'بعدی ›', tour_start: 'شروع کنیم 🚗',
    da_title: '🗑️ واقعاً حساب حذف شود؟', da_text: 'این کار قابل بازگشت نیست. دسترسی و اطلاعات شخصی‌ات حذف می‌شود. جلساتی که رانده‌ای به‌صورت ناشناس در سابقهٔ آموزش آموزشگاه می‌ماند.',
    da_pass_label: 'برای تأیید: رمز عبور فعلی‌ات', da_pass_ph: 'رمز عبور', da_word: 'حذف', da_word_label: 'برای تأیید <strong>{w}</strong> را تایپ کن',
    da_go: 'حذف دائمی حساب', da_deleting: 'در حال حذف…', da_done_alert: 'حسابت حذف شد. اکنون از سیستم خارج می‌شوی.',
    pf_photo_removed: 'عکس حذف شد', pf_geo_searching: '📍 در حال تعیین موقعیتت …', pf_addr_notfound: 'نشانی پیدا نشد – لطفاً دستی وارد کن.',
    pf_geo_ok: 'موقعیت گرفته شد ✓', pf_geo_ok_house: 'موقعیت گرفته شد ✓ – لطفاً شمارهٔ پلاک را اضافه کن.', pf_geo_unavail: 'موقعیت در دسترس نیست: {e}', pf_saved: 'پروفایل ذخیره شد ✓',
    fg_title: 'رمز عبور فراموش شده', fg_text: 'نام کاربری یا ایمیلت را وارد کن. به مربی‌ات اطلاع داده می‌شود و رمز عبور جدیدی برایت تعیین می‌کند – شخصاً به تو می‌گوید.', fg_request: 'درخواست', fg_need: 'لطفاً نام کاربری یا ایمیل را وارد کن.', fg_done: 'درخواست ثبت شد ✓ – مربی‌ات با رمز عبور جدید به تو برمی‌گردد.',
    sf_book_title: 'رزرو {label}', sf_intro: 'سفر ویژه با مدت ثابت: <strong>{dur} دقیقه</strong>. یک روز انتخاب کن – آنگاه زمان‌های شروع آزادی را نشان می‌دهم که {label} در کل آن روز در آن‌ها جا می‌شود.', sf_day: 'روز', sf_choose_day: 'یک روز انتخاب کن …', loading_short: 'در حال بارگذاری…', sf_nofit: '{label} ({dur} دقیقه) دیگر در برنامهٔ این روز جا نمی‌شود. یک روز خلوت‌تر دیگر انتخاب کن – ترجیحاً زودتر تا برای بازهٔ طولانی جا باشد.', sf_ends: '– پایان {end}', sf_confirm_title: 'رزرو {label} تأیید شود؟', sf_confirm_dur: '{dur} دقیقه · پایان {end}', sf_confirm_note: 'سفرهای ویژه برای آزمون اجباری‌اند. رزرو الزام‌آور است.', sf_booked: '{label} رزرو شد',
    gps_unavail: 'GPS در دسترس نیست', loc_error: 'خطای موقعیت: {e}', loc_sharing: 'موقعیتت به اشتراک گذاشته می‌شود 📍',
    pk_title: '📍 از کجا سوارت کنیم؟', pk_text: 'به مربی‌ات بگو از کجا می‌خواهی سوارت کند. می‌توانی از موقعیت فعلی‌ات هم استفاده کنی.', pk_label: 'محل ملاقات', pk_ph: 'مثل جلوی آموزشگاه، کنار ایستگاه …', pk_taken: '✓ موقعیت گرفته شد ({lat}, {lng})', pk_saved: 'محل ملاقات ذخیره شد ✓',
    rc_geduld_label:'صبر و آرامش', rc_geduld_q:'مربی‌ات چقدر صبور بود؟', rc_geduld_hint:'حتی وقتی چیزی خوب پیش نمی‌رفت آرام ماند؟',
    rc_erklaerung_label:'توضیح', rc_erklaerung_q:'توضیح‌ها چقدر روشن بودند؟', rc_erklaerung_hint:'همه‌چیز را توضیح داد تا فهمیدی؟',
    rc_puenktlich_label:'قابل‌اعتماد بودن', rc_puenktlich_q:'چقدر قابل‌اعتماد و وقت‌شناس بود؟', rc_puenktlich_hint:'به قرارها پایبند بود و سر وقت آمد؟',
    rc_freundlich_label:'مهربانی', rc_freundlich_q:'برخورد چقدر دوستانه بود؟', rc_freundlich_hint:'مهربان، دلگرم‌کننده و در سطح برابر؟',
    rc_sicher_label:'احساس امنیت', rc_sicher_q:'هنگام رانندگی چقدر احساس امنیت کردی؟', rc_sicher_hint:'در دستان مطمئن و ایمن در جاده؟',
    rw_1:'قابل‌قبول', rw_2:'بد نیست', rw_3:'خوب', rw_4:'خیلی خوب', rw_5:'عالی!',
    rw_intro_new:'به ما بگو آموزشت چطور بود', rw_intro_p:'با چند پرسش کوتاه مربی‌ات را ارزیابی می‌کنی – یک ستاره بزن، تمام. کمتر از یک دقیقه طول می‌کشد.',
    rw_intro_l1:'🧩 گام‌به‌گام – یک پرسش پس از دیگری', rw_intro_l2:'📸 اگر خواستی یک عکس اضافه کن', rw_intro_l3:'🙈 خودت تصمیم می‌گیری نامت نمایش داده شود (می‌تواند ناشناس باشد)',
    rw_intro_why:'نظر صادقانه‌ات به هنرجویان دیگر کمک می‌کند – و به مربی‌ات برای بهتر شدن.', rw_start:'شروع کنیم →',
    rw_qn:'پرسش {i} از {n}', rw_tap_star:'یک ستاره بزن', rw_back:'← بازگشت', rw_next:'بعدی →',
    rw_words_t:'💬 حرف‌های تو', rw_words_p:'دوست داری به دیگران چه بگویی؟ یکی دو جملهٔ صادقانه کافی است.', rw_words_ph:'مثل: مربی فوق‌العاده، بسیار صبور، همه‌چیز را با آرامش توضیح می‌دهد – قویاً توصیه می‌کنم!',
    rw_photo_t:'📸 عکس اضافه شود؟ (اختیاری)', rw_photo_p:'عکس توصیه‌ات را شخصی‌تر می‌کند. هر طور دوست داری.', rw_photo_other:'عکس دیگر', rw_photo_pick:'📷 انتخاب عکس', rw_photo_none:'بدون عکس', rw_photo_show:'نمایش عکس همراه نظرم',
    rw_name_t:'🙋 نامت چطور نمایش داده شود؟', rw_name_p:'برای عموم روی صفحهٔ اصلی نمایان است. تو تصمیم می‌گیری.', rw_name_full:'نام کامل', rw_name_init:'مخفف', rw_name_anon:'ناشناس', rw_anon_student:'یکی از هنرجویان', rw_name_anon_nophoto:'با «ناشناس» هیچ عکسی نمایش داده نمی‌شود.',
    rw_sum_t:'✅ درست است؟', rw_sum_nochips:'بدون ارزیابی جداگانه – مشکلی نیست.', rw_submit:'ارسال نظر', rw_need_text:'لطفاً یکی دو جمله بنویس.', rw_sending:'در حال ارسال …', rw_thanks:'ممنون از نظرت ⭐', actual_time:'زمان واقعی', sign_confirm_time:'جلسه و زمان نمایش‌داده‌شده را تأیید می‌کنم.', both_confirmed:'✓ زمان را مربی و هنرجو تأیید کردند', ml_actual:'🕒 رانندگی واقعی: {begin}–{end}', ml_actual_open:'🕒 شروع: {begin}',
    tour_t0: 'به ginoco خوش آمدی', tour_x0: 'اینجا خودت جلسات رانندگی را رزرو می‌کنی – سریع و از هر جا. در چند گام کوتاه نشانت می‌دهم چطور. هر زمان می‌توانی «رد کردن» را بزنی.',
    tour_t1: '۱. یک جلسه رزرو کن', tour_x1: 'سریع‌ترین راه از طریق <strong>🔎 نزدیک‌ترین نوبت آزاد</strong> است – یک کلیک تو را به نزدیک‌ترین روز آزاد می‌برد. زمان‌های آزاد <strong>سبز</strong> هستند. روی <strong>رزرو</strong> بزن، مدت را انتخاب کن و تأیید کن. تمام! ✅',
    tour_t2: '۲. نوبت‌های تو', tour_x2: 'در بالا زیر <strong>«نوبت‌های من»</strong> همهٔ جلسات را با تاریخ، ساعت و محل ملاقات می‌بینی. با <strong>«افزودن به تقویم»</strong> به تقویم گوشی‌ات اضافه می‌شوند.',
    tour_t3: '۳. وقت نداری؟', tour_x3: 'اگر آن روز نمی‌توانی: روی <strong>«🎁 این جلسه را پیشنهاد بده»</strong> بزن – هنرجوی دیگری می‌تواند آن را بگیرد (اگر بخواهی به‌صورت ناشناس). اگر کسی نگیرد برای تو می‌ماند. و اگر زود باشد می‌توانی <strong>«لغو»</strong> هم بکنی.',
    tour_t4: '۴. پروفایل تو', tour_x4: 'در بالا روی <strong>👤</strong> بزن و اطلاعاتت را کامل کن. فقط <strong>مربی‌ات</strong> آن را می‌بیند – نه هنرجوی دیگر.',
    tour_t5: 'شروع کنیم!', tour_x5: 'همین. در آموزشت موفق باشی! 🚗 این معرفی را هر زمان می‌توانی از طریق <strong>❓</strong> در بالای صفحه باز کنی.',
  },
};
function t(key, vars) {
