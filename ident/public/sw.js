 ...
 */
const CACHE = 'ident-v8';
const SHELL = ['/', '/index.html', '/app.js', '/figur-core.js', '/manifest.webmanifest', '/icon-192.png', '/zeichen-tab.svg?v=1', '/icon-512.png', '/icon-maskable-512.png'];
